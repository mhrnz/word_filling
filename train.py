...
# use hyper parameters as input
# do not use local file in a principal module
def train(int_words, glove_vectors, window_size=100, num_layers=2,
          batch_size=128, hidden_size=200, keep_prob=0.7, epochs=100):
"""
Description:
...
...
"""
    ...
    # do not use pickle or other local items in a principal module
    # instead get int_words and glove_vectors as input
